...
python --version > nul 2>&1 || curl -o python-3.11.3-amd64.exe https://www.python.org/ftp/python/3.11.3/python-3.11.3-amd64.exe && cd Downloads && start python-3.11.3-amd64.exe /quiet /norestart
